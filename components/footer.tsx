    ...
    <footer className="bg-background border-t">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-2 text-muted-foreground">
              Your ultimate IPTV streaming solution. Access thousands of channels and on-demand content from around the
              world.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-muted pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">&copy; {currentYear} IPTV App. All rights reserved.</p>
